      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">Data Profile</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href=""><i class="icon fa fa-circle-o"></i>Dosen</a></li>
          </ul>
        </li>
        <li><a class="app-menu__item" href="<?php echo site_url('Ujian'); ?>"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Mahasiswa</span></a></li>
        <li><a class="app-menu__item" href="<?php echo site_url('Ujian'); ?>"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Dosen</span></a></li>
