    <link rel="stylesheet" href="<?php echo site_url() ?>assets/s/my.css">
<div class="row">
  <div class="col-sm-6 offset-3 pt-3">    
    <div class="card card-navy">
      <div class="card-header with-border">
        <h2 class="card-title">Input Data Dosen</h2>
      </div>
    <!-- /.box-header -->
    <!-- form start -->
            <?php echo form_open('admin/save_dosen') ?>
              <div class="card-body">
                <div class="form-group row">
                    <label for="exampleInputEmail1" class="col-sm-2 col-form-label">NIDN</label>
                  <div class="col-md-10">
                    <input name="nip" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nim">
                  </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-10">
                    <input type="text" name="matkul" class="form-control" id="exampleInputPassword1" placeholder="Matkul">
                  </div>
                  </div>
                  <div class="form-group row">
